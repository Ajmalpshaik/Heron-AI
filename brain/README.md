...
**In plain words**, for anyone deciding whether to install the two search add-ons, where they live on
a PC, and what the first measurement of both found: [`docs/SEARCH-ADD-ONS.md`](../docs/SEARCH-ADD-ONS.md).
