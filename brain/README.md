...
**Proof, mostly.** **52 fragments are `PROVEN`; the other 302 and all ten skills are `DRAFT`.** Phase 2's
...
not changed, only the size of it - and four fragments added on 2026-09-08 for switching
project and view arrived `DRAFT` like everything else.
