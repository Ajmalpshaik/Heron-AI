...
**None of this goes in front of the proving pass.** 84 of the 407 fragments are `DRAFT`, that is the
...
README says a user need not *"learn 314 MCP tools or 26 CLI commands"*. **Heron has a few dozen** - `python mcp/server/heron_tools.py` lists them. That
