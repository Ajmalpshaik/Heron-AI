...
| [`plans/earlier-brain/README.md`](plans/earlier-brain/README.md) | **Active — planned 2026-09-23, nothing built from it yet.** What to take from the owner's earlier brain repository after everything in it was checked, and how: the folder's front page, its rules and its closure condition |
