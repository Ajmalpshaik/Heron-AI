...
| **C6** | A score for the owner's real questions | cloud | 1 | — | **built, draft** — PR [#305](https://github.com/Ajmalpshaik/Heron-AI/pull/305). Answer key confirmed by the owner 2026-09-23; **D3 asked, waiting** |
