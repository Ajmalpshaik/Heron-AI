...
| | Requirement | Source | State | Note |
|---|---|---|---|---|
| **R-21** | **No source, no claim.** A standards answer without a citation is a **bug**, not a low-confidence answer | [05 §8](../../../05-heron-brain.md) | **DONE 2026-09-11** | a clause is carried only WITH its citation, and a claim citing nothing is `UNCITED` rather than low-confidence |
| **R-22** | A citation resolves to something a human can open — file, page, clause | `HERON-RAG-CIT-014` | **DONE 2026-09-11** | title, locator, heading path and the file's own path. A marker naming something the packet does not carry is `UNRESOLVED` — *a tag pointing at no element* |
...
| | Requirement | Source | State | Note |
|---|---|---|---|---|
| **R-46** | Every sentence of a proposed answer that makes a **factual claim about an indexed source** is compared against the chunk it cites, before the answer is shown | [00 §3.6a](00-structure.md) | **DONE 2026-09-11** — `heron_ground.py`, `tests/test_ground.py` | |
