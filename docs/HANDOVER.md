...
1. **`python tools/review-ledger.py` says *read 142 of 1180*, and 30 of those 142 were only PARTLY
   ...
   derived from prose is guessed, not derived. A third verdict — `clean | issue | partial` — would
   make it honest. **Not done here**; it needs the 30 re-marked, and widening this change would stop
   it being reviewable.
