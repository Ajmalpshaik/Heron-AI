...
**Added 2026-09-14** with the fourteen agents of the [seam-first build
order](work-notes/plans/agent-build-order-2026-09-13.md) — the agent contract, six kernel seams and the
agent spine. **481 assertions pass, and every one of them ran on Linux, in a container, against a
dictionary a test wrote itself.** `tests/test_chain.py` narrows that a little: it walks one agent through
