...
**Does NOT need Revit** — except what is left of `A11`, which does. This group is **nine rows done of ELEVEN** — `A10` and `A11` were both added 2026-09-11 and are the two open. `A6` and `A9` both closed on
