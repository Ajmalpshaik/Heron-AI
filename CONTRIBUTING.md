...
>
> **313 of the 411 fragments are `PROVEN`** — each on a recorded run against a named model.
> **98 of the 411 fragments are `DRAFT`**, which is Heron's word for *not proven as it stands* - most
> have never met a model, and some were proved before their code changed.
> **All thirteen skills are still `DRAFT`.** Derived 2026-09-25.
>
