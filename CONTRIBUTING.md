...
>
> **322 of the 407 fragments are `PROVEN`** — each on a recorded run against a named model.
> **85 of the 407 fragments are `DRAFT`**, which is Heron's word for *has never met a model*.
