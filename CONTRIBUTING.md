...
>
> **322 of the 396 fragments are `PROVEN`** — each on a recorded run against a named model.
> **74 of the 396 fragments are `DRAFT`**, which is Heron's word for *has never met a model*.
