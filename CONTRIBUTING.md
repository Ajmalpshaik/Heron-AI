...
>
> **322 of the 398 fragments are `PROVEN`** — each on a recorded run against a named model.
> **76 of the 398 fragments are `DRAFT`**, which is Heron's word for *has never met a model*.
