...
>
> **313 of the 408 fragments are `PROVEN`** — each on a recorded run against a named model.
> **95 of the 408 fragments are `DRAFT`**, which is Heron's word for *not proven as it stands* - most
