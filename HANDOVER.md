...
## WHERE THIS STANDS, 2026-09-02 — 170 fragments, and thirty-two have never seen a compiler
...
| | |
|---|---|
| Fragments | **170**, every one `DRAFT`. 138 compiled on all eight Revit releases; **the newest 32 have not been compiled at all** — see `A9` |
...
> tools/check-fragments-compile.py`. It is now `A9` in the register. Thirty-two fragments were written on
