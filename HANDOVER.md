...
dependency or a conversation: **48 a real Revit**, plus the 70 unproven fragments as one further item,
...
**So the library is 70 fragments and every skill has every capability provided.** The seven were written
...
**What that buys, and what it does not.** All seventy fragments compile on all eight releases and
...
currently says **nothing** here is unfinished and **55 are waiting: 48 on a Revit, plus the 70 unproven
