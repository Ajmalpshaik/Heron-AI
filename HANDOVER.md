...
## WHERE THIS STANDS, 2026-09-02 — 186 fragments, and forty-eight have never seen a compiler
...
| | |
|---|---|
| Fragments | **186**, every one `DRAFT`. 138 compiled on all eight Revit releases; **the newest 48 have not been compiled at all** — see `A9` |
...
> tools/check-fragments-compile.py`. It is now `A9` in the register. Forty-eight fragments were written on
