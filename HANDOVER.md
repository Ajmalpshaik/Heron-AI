...
## WHERE THIS STANDS, 2026-09-03 — 194 fragments, and fifty-six have never seen a compiler
...
| | |
|---|---|
| Fragments | **194**, every one `DRAFT`. 138 compiled on all eight Revit releases; **the newest 56 have not been compiled at all** — see `A9` |
...
> tools/check-fragments-compile.py`. It is now `A9` in the register. Fifty-six fragments were written on
