...
## WHERE THIS STANDS, 2026-09-02 — 178 fragments, and forty have never seen a compiler
...
| | |
|---|---|
| Fragments | **178**, every one `DRAFT`. 138 compiled on all eight Revit releases; **the newest 40 have not been compiled at all** — see `A9` |
...
> tools/check-fragments-compile.py`. It is now `A9` in the register. Forty fragments were written on
