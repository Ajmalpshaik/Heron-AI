...
## WHERE THIS STANDS, 2026-09-02 — 162 fragments, and twenty-four have never seen a compiler
...
| | |
|---|---|
| Fragments | **162**, every one `DRAFT`. 138 compiled on all eight Revit releases; **the newest 24 have not been compiled at all** — see `A9` |
...
> tools/check-fragments-compile.py`. It is now `A9` in the register. Twenty-four fragments were written on
