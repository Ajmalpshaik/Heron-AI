...
**313 of the 414 fragments are `PROVEN`, re-derived 2026-09-26** — each on a recorded proof against a named
model, with a negative case and a staleness fingerprint ([D-30](docs/DECISIONS.md)).
**101 of the 414 fragments are `DRAFT`** — Heron's word for *not proven as it stands* — and twenty-three of
those were written on 2026-09-18 to close recorded gaps, nine on 2026-09-24 to build families, three the
same day to slope a roof, place room tags and set room tops, one on 2026-09-25 to set each air
terminal's design flow, and three that day to set and read a curtain wall's grid and mullions, so they
are new rather than neglected. Nine
more went back from `PROVEN` on 2026-09-24, when a refusal was added inside them
([row 5b-203](docs/FRAGMENT-ISSUES.md)).
...
| **setting up a PC** | [**docs/WHAT-TO-INSTALL.md**](docs/WHAT-TO-INSTALL.md) — everything a PC needs for Heron, Python first, and what is optional. **Nothing is released yet** |
