...
**322 of the 409 fragments are `PROVEN`, re-derived 2026-09-24** — each on a recorded proof against a named
model, with a negative case and a staleness fingerprint ([D-30](docs/DECISIONS.md)).
**87 of the 409 fragments are `DRAFT`** — Heron's word for *has never met a model* — and twenty-three of
those were written on 2026-09-18 to close recorded gaps, nine on 2026-09-24 to build families and two that
day to place room tags and set room tops, so they are new rather than neglected.
