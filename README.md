...
**328 of the 396 fragments are `PROVEN`, re-derived 2026-09-22** — each on a recorded proof against a named
model, with a negative case and a staleness fingerprint ([D-30](docs/DECISIONS.md)).
**68 of the 396 fragments are `DRAFT`** — Heron's word for *has never met a model* — and twenty-three of
