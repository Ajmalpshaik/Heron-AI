...
"""
The 884 checks that compiled every day and ran on no day.
...
`tests/test_*.py`, so 884 checks over 396 fragments sat outside every count of
...
and prints **PASSED - 884 checks, 396 fragments, 91 carrying a guard**.

THE COUNT IT WAS LAST DESCRIBED WITH WAS 372. HANDOVER says the host "runs the
rewriter over all 372 fragments: 836 checks". The library is 396 now and the
